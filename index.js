document.querySelector(".start-button").addEventListener("click", function(){
    ...
    P1Points = P2Points + randomNum1;
    P2Points = P2Points + randomNum2;
    ...
    document.querySelectorAll("h2")[0].textContent = "Total Pts: " + P1Points;
    document.querySelectorAll("h2")[1].textContent = "Total Pts: " + P2Points;
    document.querySelectorAll("h2")[0].style.fontSize = "32pt";
    document.querySelectorAll("h2")[1].style.fontSize = "32pt";
